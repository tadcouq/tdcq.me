...
const styles = {
    wrapper: {
        ...
        whiteSpace: 'pre-wrap',
        fontWeight: '900', // Added font weight for bold text
    },
    srOnly: {
        position: 'absolute',
        width: '10px',
...
export default function DecryptedText({
    ...
    return (
        <motion.span className={parentClassName} ref={containerRef} style={{ ...styles.wrapper, color, fontFamily, fontSize }} {...hoverProps} {...props}>
